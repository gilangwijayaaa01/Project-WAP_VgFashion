...
<?php
  ...
  else
  {
    echo("
    <div class='row'>
      <div class='title-card col s12'>
        <p class='col s5 center' style='padding-top: 15px; margin: 0px;'>Product</p>
        <p class='col s2 center ' style='padding-top: 15px; margin: 0px;'>Unit Price</p>
        <p class='col s1 center' style='padding-top: 15px; margin: 0px;'>Quantity</p>
