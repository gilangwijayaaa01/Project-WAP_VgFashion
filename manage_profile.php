...
<head>
  ...
  <title>VG Fashion- Manage Account</title>
...
<h3 class="page-title grid" style="margin-top: 50px;">Manage Personal Profile</h3>
  ...
  <input class="white-text validate" id="address" type="text" value="Jl. Raya Kutek Nusantara, Depok" />
  <label class="cyan-text" for="address">Enter New Address</label>
  <span class="helper-text white-text" data-error="wrong" data-success="correct"></span>
</div>
